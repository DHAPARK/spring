...
public class TalentController {
	...
	public void getTalentList(@RequestParam("n") String Kinds, @ModelAttribute("scri") SearchCriteria scri, Model model, HttpServletRequest req) throws Exception{
		...
		model.addAttribute("tals_kinds",Kinds);
	...
	public void getTalentList_2(@RequestParam("n") String Kinds, @ModelAttribute("scri") SearchCriteria scri, Model model, HttpServletRequest req) throws Exception{
		...
		model.addAttribute("tals_kinds_2",Kinds);
		model.addAttribute("member",member);
		model.addAttribute("list",list);
		model.addAttribute("list2",list2);
